...
#==================================================
              ...
              if msg.from_ in creator:
                ...
                if len(string.decode('utf-8')) <= 9999999999999999999999999999999999:
...
#==================================================================
              ...
              if msg.from_ in admin:
                ...
                cl.sendMessage(msg)
                cl.sendText(msg.to," THATS MY FUCKING STUPID CREATOR ")
...
#===========================================
            elif msg.text in ["Absen","Absen bot","Absen dulu","Respon","Responsename","responsename"]:
              if msg.from_ in admin:
                cl.sendText(msg.to,"ᴇxᴏʀᴄɪsᴛ ᴏɴᴇ (E1)")
                ki.sendText(msg.to,"ᴇxᴏʀᴄɪsᴛ ᴛᴡᴏ (E2)")
                kk.sendText(msg.to,"ᴇxᴏʀᴄɪsᴛ ᴛʜʀᴇᴇ (E3)")
                kc.sendText(msg.to,"ᴇxᴏʀᴄɪsᴛ ғᴏᴜʀ (E4)")
                ks.sendText(msg.to,"ᴇxᴏʀᴄɪsᴛ ғɪᴠᴇ (E5)")
                kt.senxText(msg.to,"ᴇxᴏʀᴄɪsᴛ sɪx (E6)")
                cl.sendText(msg.to,"ᴇxᴏʀᴄɪsᴛ HADIR BOSS\n Siap Untuk Protect Group\n Masalah Gak Aman Yang Penting Itu ada anu")
...
#-----------------------------------------------
    		...
    		jawab = ("Mereka yang hina aku, si comboy"," Dia gila")
    		jawaban = random.choice(jawab)
